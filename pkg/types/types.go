...
// Valid indicates whether the value is a known member of the IceTransportPolicy enum.
func (e IceTransportPolicy) Valid() bool {
	switch e {
	case All:
		return true
	case Public:
...
// Valid indicates whether the value is a known member of the GetTurnAuthParamsService enum.
func (e GetTurnAuthParamsService) Valid() bool {
	switch e {
	case GetTurnAuthParamsServiceTurn:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the GetIceAuthParamsService enum.
func (e GetIceAuthParamsService) Valid() bool {
	switch e {
	case GetIceAuthParamsServiceTurn:
		return true
	default:
		return false
	}
...
// IceAuthenticationToken Example: {"credential":"randomHashedPassword","urls":["turn:1.2.3.4:9991?transport=udp","turn:1.2.3.4:9992?transport=tcp","turns:1.2.3.4:443?transport=tcp"],"username":"12334939:username"}
...
// IceConfig Example: {"iceServers":[{"credential":"randomHashedPassword","urls":["turn:1.2.3.4:9991?transport=udp","turn:1.2.3.4:9992?transport=tcp","turns:1.2.3.4:443?transport=tcp"],"username":"12334939:username"},{"credential":"someOtherHashedPassword","urls":["turn:1.2.3.4:3478?transport=tcp"],"username":"987654321:othername"}],"iceTransportpolicy":"relay"}
...
// TurnAuthenticationToken Example: {"password":"randomHashedPassword","ttl":86400,"uris":["turn:1.2.3.4:9991?transport=udp","turn:1.2.3.4:9992?transport=tcp","turns:1.2.3.4:443?transport=tcp"],"username":"12334939:username"}
...
type GetTurnAuthParams struct {
	...
	// PublicAddr Override the public IP address with the provided value (optional)
	PublicAddr *string `form:"public-addr,omitempty" json:"public-addr,omitempty"`
}
